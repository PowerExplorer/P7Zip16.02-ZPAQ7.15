...
public class Zpaq
{
	...
	public static final String zpaqx86 = "/data/data/net.gnu.p7zip/commands/x86/zpaq";
	public static final String zpaqarm = "/data/data/net.gnu.p7zip/commands/armeabi-v7a/zpaq";
	...
	public Zpaq(Context ctx) {
		...
		try {
			...
			if (!new File(zpaqx86).exists()) {
				command = new Command("mkdir", "/data/data/net.gnu.p7zip/commands");//"/android_asset/"
				command.setCommandListener(new CommandListener(command));
				command.run();
				command = new Command("mkdir", "/data/data/net.gnu.p7zip/commands/x86");//"/android_asset/"
				command.setCommandListener(new CommandListener(command));
				command.run();
			...
			if (!new File(zpaqarm).exists()) {
				command = new Command("mkdir", "/data/data/net.gnu.p7zip/commands");
				command.setCommandListener(new CommandListener(command));
				command.run();
				command = new Command("mkdir", "/data/data/net.gnu.p7zip/commands/armeabi-v7a");
				command.setCommandListener(new CommandListener(command));
				command.run();
