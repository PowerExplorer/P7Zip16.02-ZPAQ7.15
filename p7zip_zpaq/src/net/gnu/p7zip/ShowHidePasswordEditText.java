...
public class ShowHidePasswordEditText extends EditText {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_visibility_black_48dp);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_visibility_off_black_48dp);
            ...
            visibilityIndicatorShow = R.drawable.ic_visibility_black_48dp;
            visibilityIndicatorHide = R.drawable.ic_visibility_off_black_48dp;
        }
...
//        });
    ...
    public void setVisibilityIndicatorShow( int visibilityIndicatorShow) {
    ...
    public void setVisibilityIndicatorHide( int visibilityIndicatorHide) {
