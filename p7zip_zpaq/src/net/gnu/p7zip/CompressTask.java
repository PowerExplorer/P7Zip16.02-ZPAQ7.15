...
//	private String encryptFileNames = "";
	...
	static final String sevenZipSupport = ".*?\\.(7z|zip|zipx|lzma2|bz2|tbz2|bzip2|tbzip2|bz|tbz|xz|txz|gz|tgz|tgzip|tz|tar|wim)";
	...
	public CompressTask(CompressFragment compressFrag) {
		...
		if (fName.matches(sevenZipSupport)) {
			this.archive = fName;// + "/" + compressFrag.fName;
		} else {
